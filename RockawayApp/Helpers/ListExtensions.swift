...
extension UIStoryboard {
    ...
    public func instantiateViewController<T: UIViewController>(className: T.Type) -> T {
        guard let viewController = instantiateViewController(withIdentifier: String(describing: className)) as? T else {
            fatalError()
        }
